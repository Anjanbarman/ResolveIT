  ...
  if (success) {
    return (
      <div className="min-h-screen bg-gray-50">
        ...
        <main className="w-full px-3 sm:px-5 md:px-6 lg:px-8 xl:px-10 2xl:px-12 py-12">
              ...
              <CardContent className="pt-12 pb-12">
                ...
                {success.trackingId && (
                  <div className="mb-6">
                    ...
                    <p className="text-2xl font-mono font-semibold text-violet-600">
                      {success.trackingId}
                    </p>
                    <p className="text-xs text-gray-500 mt-2">
                      Keep this tracking ID to check status or share with
                      support.
                    </p>
                  </div>
                )}
